...
(The repo's own `.npmrc` already points the `@platform` scope at `https://npm.pkg.github.com` and reads `GITHUB_TOKEN` from the environment — see [docs/submodule-guide.md](docs/submodule-guide.md#publishing-shared-ui--shared-utils).)
